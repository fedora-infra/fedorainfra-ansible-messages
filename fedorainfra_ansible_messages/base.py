...
class fedorainfra-ansibleMessage(message.Message):
    """
    A sub-class of a Fedora message that defines a message schema for messages
    published by fedorainfra-ansible.
    """

    @property
    def app_name(self):
        return "fedorainfra-ansible"

    @property
    def app_icon(self):
        return "https://apps.fedoraproject.org/img/icons/fedorainfra-ansible.png"
