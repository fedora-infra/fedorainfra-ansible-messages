...
from .base import SCHEMA_URL, fedorainfra-ansibleMessage, THING_SCHEMA


class NewThingV1(fedorainfra-ansibleMessage):
    """
    A sub-class of a Fedora message that defines a message schema for messages
    published by fedorainfra-ansible when a new thing is created.
    """

    topic = "fedorainfra-ansible.new"
